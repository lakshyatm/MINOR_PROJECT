...
?>
<div id="top-sale" class="box">
                <div class="container py-4">
                    <h3 class="">Top Sale</h3>
                    <hr>
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <?php 
                                            ...
                                            if (in_array($item['item_id'], $cart->getwishid($product->getwishproduct($user_id ?? 0)) ?? [])){
                                                ...
                                                echo '
                                                        <button type="submit" name="wish" data-toggle="tooltip" title="Add product in Wishlist !" class="btn btn-danger mr-1"><i class="fas fa-heart "></i></button>'
                                            ...
                                            if (in_array($item['item_id'], $cart->getcartid($product->getcartproduct($user_id ?? 0)) ?? [])){
                                                ...
                                                echo '
                                                        ...
                                                        <button type="submit" name="topsale" data-toggle="tooltip" title="To add product in Cart then You must be logged-in !" class="btn btn-warning">Add to Cart</button>'
                                                    ;
