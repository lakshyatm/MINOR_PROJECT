# Contributing to Brother Electronics Website
...
4. [Clone](https://github.com/lakshyatm/MINOR_PROJECT.git) your forked contact-app repo: git@github.com:<your-name>/contact-app.git.
